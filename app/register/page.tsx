      ...
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl shadow p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} required className="w-full border border-gray-300 rounded-md px-3 py-2 bg-white text-gray-900 placeholder-gray-500" placeholder="••••••••" />
          </div>
