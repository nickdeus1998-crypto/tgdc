...
export const metadata: Metadata = {
  title: 'Direct Use Geothermal Projects | TGDC',
  description: 'Maximizing geothermal heat for Tanzania’s wellbeing through affordable energy uses.',
};
...
export default async function ResourcePage() {
  ...
  const data = rawData ? {
    ...
    strategicProjects: parseJSON(rawData.strategicProjects, []),
    roadmap: parseJSON(rawData.roadmap, [])
  } : null;
  ...
  return (
    <>
      ...
      `}} />
      <div className="bg-gradient-to-br from-blue-50 via-white to-green-50 text-gray-800 pb-20">
        <ModalProvider>
          <HeroResourceSection
          ...
          <StrategicProjectsSection projects={data?.strategicProjects} />
